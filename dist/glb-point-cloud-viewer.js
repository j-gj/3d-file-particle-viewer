 ...
 */
const Yr = "158", Rn = { ROTATE: 0, DOLLY: 1, PAN: 2 }, wn = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 }, ho = 0, ss = 1, fo = 2, Pa = 1, po = 2, Xt = 3, cn = 0, xt = 1, qt = 2, an = 0, qn = 1, as = 2, os = 3, ls = 4, mo = 5, _n = 100, go = 101, _o = 102, cs = 103, us = 104, vo = 200, xo = 201, Mo = 202, So = 203, Nr = 204, Fr = 205, Eo = 206, To = 207, yo = 208, bo = 209, Ao = 210, Ro = 211, wo = 212, Co = 213, Po = 214, Lo = 0, Do = 1, Uo = 2, ki = 3, Io = 4, No = 5, Fo = 6, Oo = 7, La = 0, Bo = 1, zo = 2, on = 0, Go = 1, Ho = 2, Vo = 3, ko = 4, Wo = 5, Da = 300, jn = 301, Kn = 302, Or = 303, Br = 304, Ki = 306, zr = 1e3, It = 1001, Gr = 1002, mt = 1003, hs = 1004, rr = 1005, Rt = 1006, Xo = 1007, oi = 1008, ln = 1009, qo = 1010, Yo = 1011, jr = 1012, Ua = 1013, nn = 1014, rn = 1015, li = 1016, Ia = 1017, Na = 1018, xn = 1020, jo = 1021, Nt = 1023, Ko = 1024, Zo = 1025, Mn = 1026, Zn = 1027, $o = 1028, Fa = 1029, Jo = 1030, Oa = 1031, Ba = 1033, sr = 33776, ar = 33777, or = 33778, lr = 33779, ds = 35840, fs = 35841, ps = 35842, ms = 35843, Qo = 36196, gs = 37492, _s = 37496, vs = 37808, xs = 37809, Ms = 37810, Ss = 37811, Es = 37812, Ts = 37813, ys = 37814, bs = 37815, As = 37816, Rs = 37817, ws = 37818, Cs = 37819, Ps = 37820, Ls = 37821, cr = 36492, Ds = 36494, Us = 36495, el = 36283, Is = 36284, Ns = 36285, Fs = 36286, za = 3e3, Sn = 3001, tl = 3200, nl = 3201, il = 0, rl = 1, Ct = "", ot = "srgb", jt = "srgb-linear", Kr = "display-p3", Zi = "display-p3-linear", Wi = "linear", Ye = "srgb", Xi = "rec709", qi = "p3", Cn = 7680, Os = 519, sl = 512, al = 513, ol = 514, ll = 515, cl = 516, ul = 517, hl = 518, dl = 519, Bs = 35044, zs = "300 es", Hr = 1035, Yt = 2e3, Yi = 2001;
class An {
...
class Fe {
  ...
  multiplyMatrices(e, t) {
    const n = e.elements, r = t.elements, s = this.elements, o = n[0], a = n[3], l = n[6], c = n[1], u = n[4], f = n[7], d = n[2], m = n[5], _ = n[8], v = r[0], p = r[3], h = r[6], y = r[1], M = r[4], w = r[7], R = r[2], P = r[5], b = r[8];
    return s[0] = o * v + a * y + l * R, s[3] = o * p + a * M + l * P, s[6] = o * h + a * w + l * b, s[1] = c * v + u * y + f * R, s[4] = c * p + u * M + f * P, s[7] = c * h + u * w + f * b, s[2] = d * v + m * y + _ * R, s[5] = d * p + m * M + _ * P, s[8] = d * h + m * w + _ * b, this;
  }
  multiplyScalar(e) {
...
class Va {
  constructor(e = null) {
    this.isSource = !0, Object.defineProperty(this, "id", { value: _l++ }), this.uuid = ci(), this.data = e, this.version = 0;
  }
  set needsUpdate(e) {
    e === !0 && this.version++;
  }
...
class lt {
  ...
  setAxisAngleFromRotationMatrix(e) {
    let t, n, r, s;
    const l = e.elements, c = l[0], u = l[4], f = l[8], d = l[1], m = l[5], _ = l[9], v = l[2], p = l[6], h = l[10];
    if (Math.abs(u - d) < 0.01 && Math.abs(f - v) < 0.01 && Math.abs(_ - p) < 0.01) {
      if (Math.abs(u + d) < 0.1 && Math.abs(f + v) < 0.1 && Math.abs(_ + p) < 0.1 && Math.abs(c + m + h - 3) < 0.1)
        return this.set(1, 0, 0, 0), this;
      t = Math.PI;
      const M = (c + 1) / 2, w = (m + 1) / 2, R = (h + 1) / 2, P = (u + d) / 4, b = (f + v) / 4, W = (_ + p) / 4;
    ...
    let y = Math.sqrt((p - _) * (p - _) + (f - v) * (f - v) + (d - u) * (d - u));
    return Math.abs(y) < 1e-3 && (y = 1), this.x = (p - _) / y, this.y = (f - v) / y, this.z = (d - u) / y, this.w = Math.acos((c + m + h - 1) / 2), this;
  }
  min(e) {
...
class yn {
  ...
  static slerpFlat(e, t, n, r, s, o, a) {
    ...
    if (f !== v || l !== d || c !== m || u !== _) {
      let p = 1 - a;
      const h = l * d + c * m + u * _ + f * v, y = h >= 0 ? 1 : -1, M = 1 - h * h;
      if (M > Number.EPSILON) {
        const R = Math.sqrt(M), P = Math.atan2(R, h * y);
        p = Math.sin(p * P) / R, a = Math.sin(a * P) / R;
      }
      const w = a * y;
      if (l = l * p + d * w, c = c * p + m * w, u = u * p + _ * w, f = f * p + v * w, p === 1 - a) {
...
class ui {
  ...
  intersectsTriangle(e) {
    if (this.isEmpty())
      return !1;
    this.getCenter(ti), _i.subVectors(this.max, ti), Ln.subVectors(e.a, ti), Dn.subVectors(e.b, ti), Un.subVectors(e.c, ti), Zt.subVectors(Dn, Ln), $t.subVectors(Un, Dn), dn.subVectors(Ln, Un);
    let t = [
      0,
      -Zt.z,
      Zt.y,
    ...
    return !mr(t, Ln, Dn, Un, _i) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1], !mr(t, Ln, Dn, Un, _i)) ? !1 : (vi.crossVectors(Zt, $t), t = [vi.x, vi.y, vi.z], mr(t, Ln, Dn, Un, _i));
  }
  clampPoint(e, t) {
...
const Gt = [
  ...
  /* @__PURE__ */ new I(),
  /* @__PURE__ */ new I()
], Pt = /* @__PURE__ */ new I(), gi = /* @__PURE__ */ new ui(), Ln = /* @__PURE__ */ new I(), Dn = /* @__PURE__ */ new I(), Un = /* @__PURE__ */ new I(), Zt = /* @__PURE__ */ new I(), $t = /* @__PURE__ */ new I(), dn = /* @__PURE__ */ new I(), ti = /* @__PURE__ */ new I(), _i = /* @__PURE__ */ new I(), vi = /* @__PURE__ */ new I(), fn = /* @__PURE__ */ new I();
...
const Sl = /* @__PURE__ */ new ui(), ni = /* @__PURE__ */ new I(), gr = /* @__PURE__ */ new I();
class $i {
  ...
  union(e) {
    return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (gr.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(ni.copy(e.center).add(gr)), this.expandByPoint(ni.copy(e.center).sub(gr))), this);
  }
  equals(e) {
...
const Ht = /* @__PURE__ */ new I(), _r = /* @__PURE__ */ new I(), xi = /* @__PURE__ */ new I(), Jt = /* @__PURE__ */ new I(), vr = /* @__PURE__ */ new I(), Mi = /* @__PURE__ */ new I(), xr = /* @__PURE__ */ new I();
class Zr {
  ...
  distanceSqToSegment(e, t, n, r) {
    _r.copy(e).add(t).multiplyScalar(0.5), xi.copy(t).sub(e).normalize(), Jt.copy(this.origin).sub(_r);
    ...
    return n && n.copy(this.origin).addScaledVector(this.direction, f), r && r.copy(_r).addScaledVector(xi, d), m;
  }
  intersectSphere(e, t) {
...
class at {
  constructor(e, t, n, r, s, o, a, l, c, u, f, d, m, _, v, p) {
    at.prototype.isMatrix4 = !0, this.elements = [
      ...
      0,
      1
    ], e !== void 0 && this.set(e, t, n, r, s, o, a, l, c, u, f, d, m, _, v, p);
  }
  set(e, t, n, r, s, o, a, l, c, u, f, d, m, _, v, p) {
    const h = this.elements;
    return h[0] = e, h[4] = t, h[8] = n, h[12] = r, h[1] = s, h[5] = o, h[9] = a, h[13] = l, h[2] = c, h[6] = u, h[10] = f, h[14] = d, h[3] = m, h[7] = _, h[11] = v, h[15] = p, this;
  }
  identity() {
    return this.set(
      1,
  ...
  makeRotationFromEuler(e) {
    ...
    if (e.order === "XYZ") {
      const d = o * u, m = o * f, _ = a * u, v = a * f;
      t[0] = l * u, t[4] = -l * f, t[8] = c, t[1] = m + _ * c, t[5] = d - v * c, t[9] = -a * l, t[2] = v - d * c, t[6] = _ + m * c, t[10] = o * l;
    } else if (e.order === "YXZ") {
      const d = l * u, m = l * f, _ = c * u, v = c * f;
      t[0] = d + v * a, t[4] = _ * a - m, t[8] = o * c, t[1] = o * f, t[5] = o * u, t[9] = -a, t[2] = m * a - _, t[6] = v + d * a, t[10] = o * l;
    } else if (e.order === "ZXY") {
      const d = l * u, m = l * f, _ = c * u, v = c * f;
      t[0] = d - v * a, t[4] = -o * f, t[8] = _ + m * a, t[1] = m + _ * a, t[5] = o * u, t[9] = v - d * a, t[2] = -o * c, t[6] = a, t[10] = o * l;
    } else if (e.order === "ZYX") {
      const d = o * u, m = o * f, _ = a * u, v = a * f;
      t[0] = l * u, t[4] = _ * c - m, t[8] = d * c + v, t[1] = l * f, t[5] = v * c + d, t[9] = m * c - _, t[2] = -c, t[6] = a * l, t[10] = o * l;
    } else if (e.order === "YZX") {
      const d = o * l, m = o * c, _ = a * l, v = a * c;
      t[0] = l * u, t[4] = v - d * f, t[8] = _ * f + m, t[1] = f, t[5] = o * u, t[9] = -a * u, t[2] = -c * u, t[6] = m * f + _, t[10] = d - v * f;
    } else if (e.order === "XZY") {
      const d = o * l, m = o * c, _ = a * l, v = a * c;
      t[0] = l * u, t[4] = -f, t[8] = c * u, t[1] = d * f + v, t[5] = o * u, t[9] = m * f - _, t[2] = _ * f - m, t[6] = a * u, t[10] = v * f + d;
    }
  ...
  multiplyMatrices(e, t) {
    const n = e.elements, r = t.elements, s = this.elements, o = n[0], a = n[4], l = n[8], c = n[12], u = n[1], f = n[5], d = n[9], m = n[13], _ = n[2], v = n[6], p = n[10], h = n[14], y = n[3], M = n[7], w = n[11], R = n[15], P = r[0], b = r[4], W = r[8], S = r[12], T = r[1], V = r[5], J = r[9], Q = r[13], L = r[2], G = r[6], j = r[10], X = r[14], ee = r[3], q = r[7], K = r[11], D = r[15];
    return s[0] = o * P + a * T + l * L + c * ee, s[4] = o * b + a * V + l * G + c * q, s[8] = o * W + a * J + l * j + c * K, s[12] = o * S + a * Q + l * X + c * D, s[1] = u * P + f * T + d * L + m * ee, s[5] = u * b + f * V + d * G + m * q, s[9] = u * W + f * J + d * j + m * K, s[13] = u * S + f * Q + d * X + m * D, s[2] = _ * P + v * T + p * L + h * ee, s[6] = _ * b + v * V + p * G + h * q, s[10] = _ * W + v * J + p * j + h * K, s[14] = _ * S + v * Q + p * X + h * D, s[3] = y * P + M * T + w * L + R * ee, s[7] = y * b + M * V + w * G + R * q, s[11] = y * W + M * J + w * j + R * K, s[15] = y * S + M * Q + w * X + R * D, this;
  }
  multiplyScalar(e) {
    const t = this.elements;
  ...
  determinant() {
    const e = this.elements, t = e[0], n = e[4], r = e[8], s = e[12], o = e[1], a = e[5], l = e[9], c = e[13], u = e[2], f = e[6], d = e[10], m = e[14], _ = e[3], v = e[7], p = e[11], h = e[15];
    return _ * (+s * l * f - r * c * f - s * a * d + n * c * d + r * a * m - n * l * m) + v * (+t * l * m - t * c * d + s * o * d - r * o * m + r * c * u - s * l * u) + p * (+t * c * f - t * a * m - s * o * f + n * o * m + s * a * u - n * c * u) + h * (-r * a * u - t * l * f + t * a * d + r * o * f - n * o * d + n * l * u);
  }
  transpose() {
  ...
  compose(e, t, n) {
    const r = this.elements, s = t._x, o = t._y, a = t._z, l = t._w, c = s + s, u = o + o, f = a + a, d = s * c, m = s * u, _ = s * f, v = o * u, p = o * f, h = a * f, y = l * c, M = l * u, w = l * f, R = n.x, P = n.y, b = n.z;
    return r[0] = (1 - (v + h)) * R, r[1] = (m + w) * R, r[2] = (_ - M) * R, r[3] = 0, r[4] = (m - w) * P, r[5] = (1 - (d + h)) * P, r[6] = (p + y) * P, r[7] = 0, r[8] = (_ + M) * b, r[9] = (p - y) * b, r[10] = (1 - (d + v)) * b, r[11] = 0, r[12] = e.x, r[13] = e.y, r[14] = e.z, r[15] = 1, this;
  }
  decompose(e, t, n) {
    const r = this.elements;
...
class Ji {
  ...
  setFromRotationMatrix(e, t = this._order, n = !0) {
    ...
    switch (t) {
      case "XYZ":
        this._y = Math.asin(gt(a, -1, 1)), Math.abs(a) < 0.9999999 ? (this._x = Math.atan2(-u, m), this._z = Math.atan2(-o, s)) : (this._x = Math.atan2(d, c), this._z = 0);
        break;
      case "YXZ":
        this._x = Math.asin(-gt(u, -1, 1)), Math.abs(u) < 0.9999999 ? (this._y = Math.atan2(a, m), this._z = Math.atan2(l, c)) : (this._y = Math.atan2(-f, s), this._z = 0);
        break;
      case "ZXY":
        this._x = Math.asin(gt(d, -1, 1)), Math.abs(d) < 0.9999999 ? (this._y = Math.atan2(-f, m), this._z = Math.atan2(-o, c)) : (this._y = 0, this._z = Math.atan2(l, s));
        break;
      case "ZYX":
        this._y = Math.asin(-gt(f, -1, 1)), Math.abs(f) < 0.9999999 ? (this._x = Math.atan2(d, m), this._z = Math.atan2(l, s)) : (this._x = 0, this._z = Math.atan2(-o, c));
        break;
      case "YZX":
        this._z = Math.asin(gt(l, -1, 1)), Math.abs(l) < 0.9999999 ? (this._x = Math.atan2(-u, c), this._y = Math.atan2(-f, s)) : (this._x = 0, this._y = Math.atan2(a, m));
        break;
      case "XZY":
        this._z = Math.asin(-gt(o, -1, 1)), Math.abs(o) < 0.9999999 ? (this._x = Math.atan2(d, c), this._y = Math.atan2(a, s)) : (this._x = Math.atan2(-u, m), this._y = 0);
        break;
      default:
...
class _t extends An {
  constructor() {
    super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: yl++ }), this.uuid = ci(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = _t.DEFAULT_UP.clone();
...
_t.DEFAULT_UP = /* @__PURE__ */ new I(0, 1, 0);
...
class Ut {
  ...
  closestPointToPoint(e, t) {
    ...
    Tr.subVectors(e, s);
    const m = Fn.dot(Tr), _ = On.dot(Tr);
    if (_ >= 0 && m <= _)
      return t.copy(s);
    const v = m * c - l * _;
    if (v <= 0 && c >= 0 && _ <= 0)
      return a = c / (c - _), t.copy(n).addScaledVector(On, a);
    const p = u * _ - m * f;
    if (p <= 0 && f - u >= 0 && m - _ >= 0)
      return $s.subVectors(s, r), a = (f - u) / (f - u + (m - _)), t.copy(r).addScaledVector($s, a);
    const h = 1 / (p + v + d);
...
class ke {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (e = fl(e, 1), t = gt(t, 0, 1), n = gt(n, 0, 1), t === 0)
...
class hi extends An {
  constructor() {
    super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: Cl++ }), this.uuid = ci(), this.name = "", this.type = "Material", this.blending = qn, this.side = cn, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = Nr, this.blendDst = Fr, this.blendEquation = _n, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new ke(0, 0, 0), this.blendAlpha = 0, this.depthFunc = ki, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = Os, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Cn, this.stencilZFail = Cn, this.stencilZPass = Cn, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
  }
  get alphaTest() {
...
let Pl = 0;
const At = /* @__PURE__ */ new at(), br = /* @__PURE__ */ new _t(), Bn = /* @__PURE__ */ new I(), yt = /* @__PURE__ */ new ui(), ri = /* @__PURE__ */ new ui(), st = /* @__PURE__ */ new I();
class Kt extends An {
  constructor() {
  ...
  setIndex(e) {
    return Array.isArray(e) ? this.index = new (Ga(e) ? ja : Ya)(e, 1) : this.index = e, this;
  }
  getAttribute(e) {
  ...
  computeTangents() {
    ...
    for (let T = 0; T < a; T++)
      c[T] = new I(), u[T] = new I();
    const f = new I(), d = new I(), m = new I(), _ = new Oe(), v = new Oe(), p = new Oe(), h = new I(), y = new I();
    function M(T, V, J) {
      f.fromArray(r, T * 3), d.fromArray(r, V * 3), m.fromArray(r, J * 3), _.fromArray(o, T * 2), v.fromArray(o, V * 2), p.fromArray(o, J * 2), d.sub(f), m.sub(f), v.sub(_), p.sub(_);
    ...
    if (t !== void 0) {
      ...
      if (e)
        for (let d = 0, m = e.count; d < m; d += 3) {
          const _ = e.getX(d + 0), v = e.getX(d + 1), p = e.getX(d + 2);
          r.fromBufferAttribute(t, _), s.fromBufferAttribute(t, v), o.fromBufferAttribute(t, p), u.subVectors(o, s), f.subVectors(r, s), u.cross(f), a.fromBufferAttribute(n, _), l.fromBufferAttribute(n, v), c.fromBufferAttribute(n, p), a.add(u), l.add(u), c.add(u), n.setXYZ(_, a.x, a.y, a.z), n.setXYZ(v, l.x, l.y, l.z), n.setXYZ(p, c.x, c.y, c.z);
        }
      else
...
const Js = /* @__PURE__ */ new at(), pn = /* @__PURE__ */ new Zr(), Ai = /* @__PURE__ */ new $i(), Qs = /* @__PURE__ */ new I(), zn = /* @__PURE__ */ new I(), Gn = /* @__PURE__ */ new I(), Hn = /* @__PURE__ */ new I(), Ar = /* @__PURE__ */ new I(), Ri = /* @__PURE__ */ new I(), wi = /* @__PURE__ */ new Oe(), Ci = /* @__PURE__ */ new Oe(), Pi = /* @__PURE__ */ new Oe(), ea = /* @__PURE__ */ new I(), ta = /* @__PURE__ */ new I(), na = /* @__PURE__ */ new I(), Li = /* @__PURE__ */ new I(), Di = /* @__PURE__ */ new I();
class sn extends _t {
    ...
    if (a !== null)
      if (Array.isArray(o))
        for (let _ = 0, v = d.length; _ < v; _++) {
          const p = d[_], h = o[p.materialIndex], y = Math.max(p.start, m.start), M = Math.min(a.count, Math.min(p.start + p.count, m.start + m.count));
      ...
      if (Array.isArray(o))
        for (let _ = 0, v = d.length; _ < v; _++) {
          const p = d[_], h = o[p.materialIndex], y = Math.max(p.start, m.start), M = Math.min(l.count, Math.min(p.start + p.count, m.start + m.count));
          for (let w = y, R = M; w < R; w += 3) {
...
function Ui(i, e, t, n, r, s, o, a, l, c) {
  i.getVertexPosition(a, zn), i.getVertexPosition(l, Gn), i.getVertexPosition(c, Hn);
  const u = Ll(i, e, t, n, zn, Gn, Hn, Li);
  if (u) {
    r && (wi.fromBufferAttribute(r, a), Ci.fromBufferAttribute(r, l), Pi.fromBufferAttribute(r, c), u.uv = Ut.getInterpolation(Li, zn, Gn, Hn, wi, Ci, Pi, new Oe())), s && (wi.fromBufferAttribute(s, a), Ci.fromBufferAttribute(s, l), Pi.fromBufferAttribute(s, c), u.uv1 = Ut.getInterpolation(Li, zn, Gn, Hn, wi, Ci, Pi, new Oe()), u.uv2 = u.uv1), o && (ea.fromBufferAttribute(o, a), ta.fromBufferAttribute(o, l), na.fromBufferAttribute(o, c), u.normal = Ut.getInterpolation(Li, zn, Gn, Hn, ea, ta, na, new I()), u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
    const f = {
      a,
      b: l,
      c,
    ...
    Ut.getNormal(zn, Gn, Hn, f.normal), u.face = f;
  }
  return u;
}
class di extends Kt {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, o = 1) {
    ...
    const l = [], c = [], u = [], f = [];
    let d = 0, m = 0;
    _("z", "y", "x", -1, -1, n, t, e, o, s, 0), _("z", "y", "x", 1, -1, n, t, -e, o, s, 1), _("x", "z", "y", 1, 1, e, n, t, r, o, 2), _("x", "z", "y", 1, -1, e, n, -t, r, o, 3), _("x", "y", "z", 1, -1, e, t, n, r, s, 4), _("x", "y", "z", -1, -1, e, t, -n, r, s, 5), this.setIndex(l), this.setAttribute("position", new En(c, 3)), this.setAttribute("normal", new En(u, 3)), this.setAttribute("uv", new En(f, 2));
    function _(v, p, h, y, M, w, R, P, b, W, S) {
      const T = w / b, V = R / W, J = w / 2, Q = R / 2, L = P / 2, G = b + 1, j = W + 1;
      let X = 0, ee = 0;
      const q = new I();
      for (let K = 0; K < j; K++) {
        const D = K * V - Q;
      ...
      for (let K = 0; K < W; K++)
        for (let D = 0; D < b; D++) {
          const k = d + D + G * K, ce = d + D + G * (K + 1), ue = d + (D + 1) + G * (K + 1), fe = d + (D + 1) + G * K;
...
class wt extends Za {
  ...
  updateProjectionMatrix() {
    const e = this.near;
    let t = e * Math.tan(Hi * 0.5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, s = -0.5 * r;
    const o = this.view;
...
class Fl extends _t {
  ...
  update(e, t) {
    ...
    n.texture.generateMipmaps = !1, e.setRenderTarget(n, 0, r), e.render(t, s), e.setRenderTarget(n, 1, r), e.render(t, o), e.setRenderTarget(n, 2, r), e.render(t, a), e.setRenderTarget(n, 3, r), e.render(t, l), e.setRenderTarget(n, 4, r), e.render(t, c), n.texture.generateMipmaps = v, e.setRenderTarget(n, 5, r), e.render(t, u), e.setRenderTarget(f, d, m), e.xr.enabled = _, n.texture.needsPMREMUpdate = !0;
  }
}
class $a extends Mt {
...
class Ja {
  ...
  setFromProjectionMatrix(e, t = Yt) {
    const n = this.planes, r = e.elements, s = r[0], o = r[1], a = r[2], l = r[3], c = r[4], u = r[5], f = r[6], d = r[7], m = r[8], _ = r[9], v = r[10], p = r[11], h = r[12], y = r[13], M = r[14], w = r[15];
    if (n[0].setComponents(l - s, d - c, p - m, w - h).normalize(), n[1].setComponents(l + s, d + c, p + m, w + h).normalize(), n[2].setComponents(l + o, d + u, p + _, w + y).normalize(), n[3].setComponents(l - o, d - u, p - _, w - y).normalize(), n[4].setComponents(l - a, d - f, p - v, w - M).normalize(), t === Yt)
...
class $r extends Kt {
  constructor(e = 1, t = 1, n = 1, r = 1) {
    ...
    const s = e / 2, o = t / 2, a = Math.floor(n), l = Math.floor(r), c = a + 1, u = l + 1, f = e / a, d = t / l, m = [], _ = [], v = [], p = [];
    for (let h = 0; h < u; h++) {
      const y = h * d - o;
      for (let M = 0; M < c; M++) {
        const w = M * f - s;
        _.push(w, -y, 0), v.push(0, 0, 1), p.push(M / a), p.push(1 - h / l);
      }
    }
    for (let h = 0; h < l; h++)
      for (let y = 0; y < a; y++) {
    ...
    this.setIndex(m), this.setAttribute("position", new En(_, 3)), this.setAttribute("normal", new En(v, 3)), this.setAttribute("uv", new En(p, 2));
  }
  copy(e) {
    return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
  }
...
function xh(i, e, t, n) {
  ...
  function f(L, G, j, X, ee) {
    ...
    ee !== null && t.update(ee, i.ELEMENT_ARRAY_BUFFER), (q || u) && (u = !1, W(L, G, j, X), ee !== null && i.bindBuffer(i.ELEMENT_ARRAY_BUFFER, t.get(ee).buffer));
  }
  function d() {
  ...
  function h(L, G, j, X) {
    const ee = c.attributes, q = G.attributes;
    let K = 0;
  ...
  function R(L, G) {
    ...
    j[L] = 1, X[L] === 0 && (i.enableVertexAttribArray(L), X[L] = 1), ee[L] !== G && ((n.isWebGL2 ? i : e.get("ANGLE_instanced_arrays"))[n.isWebGL2 ? "vertexAttribDivisor" : "vertexAttribDivisorANGLE"](L, G), ee[L] = G);
  }
  function P() {
    const L = c.newAttributes, G = c.enabledAttributes;
    for (let j = 0, X = G.length; j < X; j++)
      G[j] !== L[j] && (i.disableVertexAttribArray(j), G[j] = 0);
  }
  function b(L, G, j, X, ee, q, K) {
    K === !0 ? i.vertexAttribIPointer(L, G, j, ee, q) : i.vertexAttribPointer(L, G, j, X, ee, q);
  }
  function W(L, G, j, X) {
    if (n.isWebGL2 === !1 && (L.isInstancedMesh || X.isInstancedBufferGeometry) && e.get("ANGLE_instanced_arrays") === null)
      return;
    M();
    const ee = X.attributes, q = j.getAttributes(), K = G.defaultAttributeValues;
    for (const D in q) {
      const k = q[D];
      if (k.location >= 0) {
        let ce = ee[D];
...
function Eh(i) {
  ...
  this.uniform = l, this.numPlanes = 0, this.numIntersection = 0, this.init = function(f, d) {
    ...
    const _ = f.clippingPlanes, v = f.clipIntersection, p = f.clipShadows, h = i.get(f);
    if (!r || _ === null || _.length === 0 || s && !p)
      s ? u(null) : c();
    else {
      const y = s ? 0 : n, M = y * 4;
      let w = h.clippingState || null;
      l.value = w, w = u(_, d, M, m);
      for (let R = 0; R !== M; ++R)
        w[R] = t[R];
...
const gn = (1 + Math.sqrt(5)) / 2, Wn = 1 / gn, sa = [
  /* @__PURE__ */ new I(1, 1, 1),
  /* @__PURE__ */ new I(-1, 1, 1),
  /* @__PURE__ */ new I(1, 1, -1),
  /* @__PURE__ */ new I(-1, 1, -1),
  /* @__PURE__ */ new I(0, gn, Wn),
  /* @__PURE__ */ new I(0, gn, -Wn),
  /* @__PURE__ */ new I(Wn, 0, gn),
  /* @__PURE__ */ new I(-Wn, 0, gn),
  /* @__PURE__ */ new I(gn, Wn, 0),
  /* @__PURE__ */ new I(-gn, Wn, 0)
];
class aa {
  constructor(e) {
  ...
  _sceneToCubeUV(e, t, n, r) {
    ...
    for (let h = 0; h < 6; h++) {
      ...
      Fi(r, y * M, h > 2 ? M : 0, M, M), u.setRenderTarget(r), v && u.render(_, a), u.render(e, a);
    }
  ...
  _halfBlur(e, t, n, r, s, o, a) {
    ...
    const u = 3, f = new sn(this._lodPlanes[r], c), d = c.uniforms, m = this._sizeLods[n] - 1, _ = isFinite(s) ? Math.PI / (2 * m) : 2 * Math.PI / (2 * vn - 1), v = s / _, p = isFinite(s) ? 1 + Math.floor(u * v) : vn;
...
function bh(i) {
  ...
  for (let o = 0; o < s; o++) {
    ...
    const c = 1 / (a - 2), u = -c, f = 1 + c, d = [u, u, f, u, f, f, u, u, f, f, u, f], m = 6, _ = 6, v = 3, p = 2, h = 1, y = new Float32Array(v * _ * m), M = new Float32Array(p * _ * m), w = new Float32Array(h * _ * m);
    for (let P = 0; P < m; P++) {
...
function Ph(i, e, t, n) {
  ...
  function f(d, m, _) {
    ...
    v[p](s, m, a, d * l, _), t.update(m, s, _);
  }
  ...
  function l(c, u, f) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (v === void 0 || v.count !== _) {
        ...
        const V = new Float32Array(S * T * 4 * _), J = new ka(V, S, T, _);
        J.type = rn, J.needsUpdate = !0;
        const Q = W * 4;
        for (let G = 0; G < _; G++) {
          const j = R[G], X = P[G], ee = b[G], q = S * T * 4 * G;
...
function Xd(i, e, t, n) {
  ...
  const l = Gd(t), c = Hd(t), u = Vd(t), f = kd(t), d = Wd(t), m = t.isWebGL2 ? "" : Dd(t), _ = Ud(s), v = r.createProgram();
    ...
    if (i.debug.checkShaderErrors) {
      ...
      if (r.getProgramParameter(v, r.LINK_STATUS) === !1)
        if (G = !1, typeof i.debug.onShaderError == "function")
          ...
          const X = _a(r, R, "vertex"), ee = _a(r, P, "fragment");
          console.error(
...
function Kd(i, e, t, n, r, s, o) {
  ...
  function p(S, T, V, J, Q) {
    const L = J.fog, G = Q.geometry, j = S.isMeshStandardMaterial ? J.environment : null, X = (S.isMeshStandardMaterial ? t : e).get(S.envMap || j), ee = X && X.mapping === Ki ? X.image.height : null, q = _[S.type];
    ...
    const K = G.morphAttributes.position || G.morphAttributes.normal || G.morphAttributes.color, D = K !== void 0 ? K.length : 0;
    let k = 0;
    G.morphAttributes.position !== void 0 && (k = 1), G.morphAttributes.normal !== void 0 && (k = 2), G.morphAttributes.color !== void 0 && (k = 3);
    let ce, ue, fe, Te;
    if (q) {
      const Je = Bt[q];
    ...
    const Be = i.getRenderTarget(), ye = Q.isInstancedMesh === !0, we = !!S.map, qe = !!S.matcap, Ue = !!X, N = !!S.aoMap, ct = !!S.lightMap, xe = !!S.bumpMap, be = !!S.normalMap, Ae = !!S.displacementMap, je = !!S.emissiveMap, Le = !!S.metalnessMap, Ce = !!S.roughnessMap, Ve = S.anisotropy > 0, $e = S.clearcoat > 0, it = S.iridescence > 0, E = S.sheen > 0, g = S.transmission > 0, F = Ve && !!S.anisotropyMap, te = $e && !!S.clearcoatMap, Z = $e && !!S.clearcoatNormalMap, ne = $e && !!S.clearcoatRoughnessMap, me = it && !!S.iridescenceMap, se = it && !!S.iridescenceThicknessMap, le = E && !!S.sheenColorMap, A = E && !!S.sheenRoughnessMap, re = !!S.specularMap, Y = !!S.specularColorMap, Se = !!S.specularIntensityMap, ge = g && !!S.transmissionMap, Me = g && !!S.thicknessMap, pe = !!S.gradientMap, de = !!S.alphaMap, ze = S.alphaTest > 0, C = !!S.alphaHash, ae = !!S.extensions, $ = !!G.attributes.uv1, H = !!G.attributes.uv2, ie = !!G.attributes.uv3;
    let ve = on;
    return S.toneMapped && (Be === null || Be.isXRRenderTarget === !0) && (ve = i.toneMapping), {
      ...
      //
      vertexTangents: !!G.attributes.tangent && (be || Ve),
      vertexColors: S.vertexColors,
      vertexAlphas: S.vertexColors === !0 && !!G.attributes.color && G.attributes.color.itemSize === 4,
      vertexUv1s: $,
      vertexUv2s: H,
      vertexUv3s: ie,
      pointsUvs: Q.isPoints === !0 && !!G.attributes.uv && (we || de),
      fog: !!L,
      useFog: S.fog === !0,
...
function Ta() {
  ...
  function o(f, d, m, _, v, p) {
    ...
    return h === void 0 ? (h = {
      ...
      z: v,
      group: p
    }, i[e] = h) : (h.id = f.id, h.object = f, h.geometry = d, h.material = m, h.groupOrder = _, h.renderOrder = f.renderOrder, h.z = v, h.group = p), e++, h;
  }
  function a(f, d, m, _, v, p) {
    const h = o(f, d, m, _, v, p);
...
function rf(i, e) {
  ...
  function l(u, f) {
    ...
    for (let J = 0, Q = u.length; J < Q; J++) {
      const L = u[J], G = L.color, j = L.intensity, X = L.distance, ee = L.shadow && L.shadow.map ? L.shadow.map.texture : null;
      if (L.isAmbientLight)
        d += G.r * j * T, m += G.g * j * T, _ += G.b * j * T;
        ...
        const q = t.get(L);
        q.position.setFromMatrixPosition(L.matrixWorld), q.color.copy(G).multiplyScalar(j * T), q.distance = X, q.coneCos = Math.cos(L.angle), q.penumbraCos = Math.cos(L.angle * (1 - L.penumbra)), q.decay = L.decay, r.spot[h] = q;
        const K = L.shadow;
        ...
        const q = t.get(L);
        q.color.copy(G).multiplyScalar(j), q.halfWidth.set(L.width * 0.5, 0, 0), q.halfHeight.set(0, L.height * 0.5, 0), r.rectArea[y] = q, y++;
  ...
  function c(u, f) {
    ...
    for (let y = 0, M = u.length; y < M; y++) {
      ...
      if (w.isDirectionalLight) {
        ...
        const R = r.spot[_];
        R.position.setFromMatrixPosition(w.matrixWorld), R.position.applyMatrix4(h), R.direction.setFromMatrixPosition(w.matrixWorld), s.setFromMatrixPosition(w.target.matrixWorld), R.direction.sub(s), R.direction.transformDirection(h), _++;
  ...
  function w(R, P, b, W, S) {
    ...
    if (R.layers.test(P.layers) && (R.isMesh || R.isLine || R.isPoints) && (R.castShadow || R.receiveShadow && S === Xt) && (!R.frustumCulled || n.intersectsObject(R))) {
      ...
      if (Array.isArray(Q)) {
        const L = J.groups;
        for (let G = 0, j = L.length; G < j; G++) {
          const X = L[G], ee = Q[X.materialIndex];
          if (ee && ee.visible) {
            const q = M(R, ee, W, S);
...
function hf(i, e, t) {
  ...
  function r() {
    ...
    return {
      ...
      setClear: function(ie, ve, Ge, Je, bt) {
        bt === !0 && (ie *= Je, ve *= Je, Ge *= Je), ae.set(ie, ve, Ge, Je), H.equals(ae) === !1 && (i.clearColor(ie, ve, Ge, Je), H.copy(ae));
      },
      reset: function() {
        C = !1, $ = null, H.set(-1, 0, 0, 0);
      }
    };
  }
  function s() {
    let C = !1, ae = null, $ = null, H = null;
    return {
      setTest: function(ie) {
      ...
      setClear: function(ie) {
        H !== ie && (i.clearDepth(ie), H = ie);
      },
      reset: function() {
        C = !1, ae = null, $ = null, H = null;
      }
    };
  }
  function o() {
    let C = !1, ae = null, $ = null, H = null, ie = null, ve = null, Ge = null, Je = null, bt = null;
    return {
      setTest: function(Xe) {
      ...
      setFunc: function(Xe, dt, Ot) {
        ($ !== Xe || H !== dt || ie !== Ot) && (i.stencilFunc(Xe, dt, Ot), $ = Xe, H = dt, ie = Ot);
      },
      setOp: function(Xe, dt, Ot) {
        (ve !== Xe || Ge !== dt || Je !== Ot) && (i.stencilOp(Xe, dt, Ot), ve = Xe, Ge = dt, Je = Ot);
      },
      ...
      reset: function() {
        C = !1, ae = null, $ = null, H = null, ie = null, ve = null, Ge = null, Je = null, bt = null;
      }
    };
  }
  const a = new r(), l = new s(), c = new o(), u = /* @__PURE__ */ new WeakMap(), f = /* @__PURE__ */ new WeakMap();
  let d = {}, m = {}, _ = /* @__PURE__ */ new WeakMap(), v = [], p = null, h = !1, y = null, M = null, w = null, R = null, P = null, b = null, W = null, S = new ke(0, 0, 0), T = 0, V = !1, J = null, Q = null, L = null, G = null, j = null;
  ...
  function Be(C, ae, $, H) {
    ...
    for (let Ge = 0; Ge < $; Ge++)
      n && (C === i.TEXTURE_3D || C === i.TEXTURE_2D_ARRAY) ? i.texImage3D(ae, 0, i.RGBA, 1, 1, H, 0, i.RGBA, i.UNSIGNED_BYTE, ie) : i.texImage2D(ae + Ge, 0, i.RGBA, 1, 1, 0, i.RGBA, i.UNSIGNED_BYTE, ie);
    return ve;
  }
  const ye = {};
  ...
  function N(C, ae) {
    let $ = v, H = !1;
    if (C)
      if ($ = _.get(ae), $ === void 0 && ($ = [], _.set(ae, $)), C.isWebGLMultipleRenderTargets) {
        const ie = C.texture;
        if ($.length !== ie.length || $[0] !== i.COLOR_ATTACHMENT0) {
          for (let ve = 0, Ge = ie.length; ve < Ge; ve++)
            $[ve] = i.COLOR_ATTACHMENT0 + ve;
          $.length = ie.length, H = !0;
        }
      } else
        $[0] !== i.COLOR_ATTACHMENT0 && ($[0] = i.COLOR_ATTACHMENT0, H = !0);
    else
      $[0] !== i.BACK && ($[0] = i.BACK, H = !0);
    H && (t.isWebGL2 ? i.drawBuffers($) : e.get("WEBGL_draw_buffers").drawBuffersWEBGL($));
  }
  function ct(C) {
  ...
  function Ae(C, ae, $, H, ie, ve, Ge, Je, bt, Xe) {
    if (C === an) {
      h === !0 && (qe(i.BLEND), h = !1);
      return;
    }
    if (h === !1 && (we(i.BLEND), h = !0), C !== mo) {
      if (C !== y || Xe !== V) {
        if ((M !== _n || P !== _n) && (i.blendEquation(i.FUNC_ADD), M = _n, P = _n), Xe)
          switch (C) {
            case qn:
    ...
    ie = ie || ae, ve = ve || $, Ge = Ge || H, (ae !== M || ie !== P) && (i.blendEquationSeparate(xe[ae], xe[ie]), M = ae, P = ie), ($ !== w || H !== R || ve !== b || Ge !== W) && (i.blendFuncSeparate(be[$], be[H], be[ve], be[Ge]), w = $, R = H, b = ve, W = Ge), (Je.equals(S) === !1 || bt !== T) && (i.blendColor(Je.r, Je.g, Je.b, bt), S.copy(Je), T = bt), y = C, V = !1;
  }
  function je(C, ae) {
    ...
    const H = C.stencilWrite;
    c.setTest(H), H && (c.setMask(C.stencilWriteMask), c.setFunc(C.stencilFunc, C.stencilRef, C.stencilFuncMask), c.setOp(C.stencilFail, C.stencilZFail, C.stencilZPass)), $e(C.polygonOffset, C.polygonOffsetFactor, C.polygonOffsetUnits), C.alphaToCoverage === !0 ? we(i.SAMPLE_ALPHA_TO_COVERAGE) : qe(i.SAMPLE_ALPHA_TO_COVERAGE);
  }
  function Le(C) {
  ...
  function $e(C, ae, $) {
    C ? (we(i.POLYGON_OFFSET_FILL), (G !== ae || j !== $) && (i.polygonOffset(ae, $), G = ae, j = $)) : qe(i.POLYGON_OFFSET_FILL);
  }
  function it(C) {
  ...
  function g(C, ae, $) {
    ...
    let H = k[$];
    H === void 0 && (H = { type: void 0, texture: void 0 }, k[$] = H), (H.type !== C || H.texture !== ae) && (D !== $ && (i.activeTexture($), D = $), i.bindTexture(C, ae || ye[C]), H.type = C, H.texture = ae);
  }
  function F() {
    const C = k[D];
  ...
  function pe(C, ae) {
    ...
    let H = $.get(C);
    H === void 0 && (H = i.getUniformBlockIndex(ae, C.name), $.set(C, H));
  }
  function de(C, ae) {
    const H = f.get(ae).get(C);
    u.get(ae) !== H && (i.uniformBlockBinding(ae, H, C.__bindingPointIndex), u.set(ae, H));
  }
  function ze() {
    i.disable(i.BLEND), i.disable(i.CULL_FACE), i.disable(i.DEPTH_TEST), i.disable(i.POLYGON_OFFSET_FILL), i.disable(i.SCISSOR_TEST), i.disable(i.STENCIL_TEST), i.disable(i.SAMPLE_ALPHA_TO_COVERAGE), i.blendEquation(i.FUNC_ADD), i.blendFunc(i.ONE, i.ZERO), i.blendFuncSeparate(i.ONE, i.ZERO, i.ONE, i.ZERO), i.blendColor(0, 0, 0, 0), i.colorMask(!0, !0, !0, !0), i.clearColor(0, 0, 0, 0), i.depthMask(!0), i.depthFunc(i.LESS), i.clearDepth(1), i.stencilMask(4294967295), i.stencilFunc(i.ALWAYS, 0, 4294967295), i.stencilOp(i.KEEP, i.KEEP, i.KEEP), i.clearStencil(0), i.cullFace(i.BACK), i.frontFace(i.CCW), i.polygonOffset(0, 0), i.activeTexture(i.TEXTURE0), i.bindFramebuffer(i.FRAMEBUFFER, null), n === !0 && (i.bindFramebuffer(i.DRAW_FRAMEBUFFER, null), i.bindFramebuffer(i.READ_FRAMEBUFFER, null)), i.useProgram(null), i.lineWidth(1), i.scissor(0, 0, i.canvas.width, i.canvas.height), i.viewport(0, 0, i.canvas.width, i.canvas.height), d = {}, D = null, k = {}, m = {}, _ = /* @__PURE__ */ new WeakMap(), v = [], p = null, h = !1, y = null, M = null, w = null, R = null, P = null, b = null, W = null, S = new ke(0, 0, 0), T = 0, V = !1, J = null, Q = null, L = null, G = null, j = null, fe.set(0, 0, i.canvas.width, i.canvas.height), Te.set(0, 0, i.canvas.width, i.canvas.height), a.reset(), l.reset(), c.reset();
  }
  return {
    buffers: {
      color: a,
...
function df(i, e, t, n, r, s, o) {
  const a = r.isWebGL2, l = r.maxTextures, c = r.maxCubemapSize, u = r.maxTextureSize, f = r.maxSamples, d = e.has("WEBGL_multisampled_render_to_texture") ? e.get("WEBGL_multisampled_render_to_texture") : null, m = typeof navigator > "u" ? !1 : /OculusBrowser/g.test(navigator.userAgent), _ = /* @__PURE__ */ new WeakMap();
  let v;
  ...
  function M(E, g, F, te) {
    let Z = 1;
    if ((E.width > te || E.height > te) && (Z = te / Math.max(E.width, E.height)), Z < 1 || g === !0)
      if (typeof HTMLImageElement < "u" && E instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && E instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && E instanceof ImageBitmap) {
        const ne = g ? kr : Math.floor, me = ne(Z * E.width), se = ne(Z * E.height);
        v === void 0 && (v = y(me, se));
  ...
  function P(E, g) {
    return E.generateMipmaps && g && E.minFilter !== mt && E.minFilter !== Rt;
  }
  function b(E) {
    i.generateMipmap(E);
  }
  function W(E, g, F, te, Z = !1) {
    if (a === !1) return g;
    if (E !== null) {
  ...
  function S(E, g, F) {
    return P(E, F) === !0 || E.isFramebufferTexture && E.minFilter !== mt && E.minFilter !== Rt ? Math.log2(Math.max(g.width, g.height)) + 1 : E.mipmaps !== void 0 && E.mipmaps.length > 0 ? E.mipmaps.length : E.isCompressedTexture && Array.isArray(E.image) ? g.mipmaps.length : 1;
  }
  function T(E) {
  ...
  function V(E) {
    const g = E.target;
    g.removeEventListener("dispose", V), Q(g), g.isVideoTexture && _.delete(g);
  }
  function J(E) {
    const g = E.target;
    g.removeEventListener("dispose", J), G(g);
  }
  function Q(E) {
    const g = n.get(E);
  ...
  function G(E) {
    ...
    if (E.isWebGLMultipleRenderTargets)
      for (let Z = 0, ne = g.length; Z < ne; Z++) {
        const me = n.get(g[Z]);
  ...
  function Be(E, g, F) {
    if (F ? (i.texParameteri(E, i.TEXTURE_WRAP_S, ue[g.wrapS]), i.texParameteri(E, i.TEXTURE_WRAP_T, ue[g.wrapT]), (E === i.TEXTURE_3D || E === i.TEXTURE_2D_ARRAY) && i.texParameteri(E, i.TEXTURE_WRAP_R, ue[g.wrapR]), i.texParameteri(E, i.TEXTURE_MAG_FILTER, fe[g.magFilter]), i.texParameteri(E, i.TEXTURE_MIN_FILTER, fe[g.minFilter])) : (i.texParameteri(E, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE), i.texParameteri(E, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE), (E === i.TEXTURE_3D || E === i.TEXTURE_2D_ARRAY) && i.texParameteri(E, i.TEXTURE_WRAP_R, i.CLAMP_TO_EDGE), (g.wrapS !== It || g.wrapT !== It) && console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."), i.texParameteri(E, i.TEXTURE_MAG_FILTER, T(g.magFilter)), i.texParameteri(E, i.TEXTURE_MIN_FILTER, T(g.minFilter)), g.minFilter !== mt && g.minFilter !== Rt && console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")), g.compareFunction && (i.texParameteri(E, i.TEXTURE_COMPARE_MODE, i.COMPARE_REF_TO_TEXTURE), i.texParameteri(E, i.TEXTURE_COMPARE_FUNC, Te[g.compareFunction])), e.has("EXT_texture_filter_anisotropic") === !0) {
      ...
      if (g.magFilter === mt || g.minFilter !== rr && g.minFilter !== oi || g.type === rn && e.has("OES_texture_float_linear") === !1 || a === !1 && g.type === li && e.has("OES_texture_half_float_linear") === !1) return;
  ...
  function ye(E, g) {
    let F = !1;
    E.__webglInit === void 0 && (E.__webglInit = !0, g.addEventListener("dispose", V));
    const te = g.source;
    let Z = p.get(te);
    ...
    if (ne !== E.__cacheKey) {
      ...
      me !== void 0 && (Z[E.__cacheKey].usedTimes--, me.usedTimes === 0 && L(g)), E.__cacheKey = ne, E.__webglTexture = Z[ne].texture;
    }
    return F;
  }
  function we(E, g, F) {
    ...
    const Z = ye(E, g), ne = g.source;
    t.bindTexture(te, E.__webglTexture, i.TEXTURE0 + F);
    const me = n.get(ne);
    if (ne.version !== me.__version || Z === !0) {
      t.activeTexture(i.TEXTURE0 + F);
      const se = We.getPrimaries(We.workingColorSpace), le = g.colorSpace === Ct ? null : We.getPrimaries(g.colorSpace), A = g.colorSpace === Ct || se === le ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, g.flipY), i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, g.premultiplyAlpha), i.pixelStorei(i.UNPACK_ALIGNMENT, g.unpackAlignment), i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL, A);
      const re = R(g) && w(g.image) === !1;
      let Y = M(g.image, re, !1, u);
      Y = it(g, Y);
      const Se = w(Y) || a, ge = s.convert(g.format, g.colorSpace);
      let Me = s.convert(g.type), pe = W(g.internalFormat, ge, Me, g.colorSpace, g.isVideoTexture);
      Be(te, g, Se);
      let de;
      const ze = g.mipmaps, C = a && g.isVideoTexture !== !0, ae = me.__version === void 0 || Z === !0, $ = S(g, Y, Se);
      if (g.isDepthTexture)
        pe = i.DEPTH_COMPONENT, a ? g.type === rn ? pe = i.DEPTH_COMPONENT32F : g.type === nn ? pe = i.DEPTH_COMPONENT24 : g.type === xn ? pe = i.DEPTH24_STENCIL8 : pe = i.DEPTH_COMPONENT16 : g.type === rn && console.error("WebGLRenderer: Floating point depth texture requires WebGL2."), g.format === Mn && pe === i.DEPTH_COMPONENT && g.type !== jr && g.type !== nn && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."), g.type = nn, Me = s.convert(g.type)), g.format === Zn && pe === i.DEPTH_COMPONENT && (pe = i.DEPTH_STENCIL, g.type !== xn && (console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."), g.type = xn, Me = s.convert(g.type))), ae && (C ? t.texStorage2D(i.TEXTURE_2D, 1, pe, Y.width, Y.height) : t.texImage2D(i.TEXTURE_2D, 0, pe, Y.width, Y.height, 0, ge, Me, null));
      else if (g.isDataTexture)
        if (ze.length > 0 && Se) {
          C && ae && t.texStorage2D(i.TEXTURE_2D, $, pe, ze[0].width, ze[0].height);
          for (let H = 0, ie = ze.length; H < ie; H++)
            de = ze[H], C ? t.texSubImage2D(i.TEXTURE_2D, H, 0, 0, de.width, de.height, ge, Me, de.data) : t.texImage2D(i.TEXTURE_2D, H, pe, de.width, de.height, 0, ge, Me, de.data);
          g.generateMipmaps = !1;
        } else
          C ? (ae && t.texStorage2D(i.TEXTURE_2D, $, pe, Y.width, Y.height), t.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, Y.width, Y.height, ge, Me, Y.data)) : t.texImage2D(i.TEXTURE_2D, 0, pe, Y.width, Y.height, 0, ge, Me, Y.data);
        ...
        if (g.isCompressedArrayTexture) {
          ...
          for (let H = 0, ie = ze.length; H < ie; H++)
            de = ze[H], g.format !== Nt ? ge !== null ? C ? t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY, H, 0, 0, 0, de.width, de.height, Y.depth, ge, de.data, 0, 0) : t.compressedTexImage3D(i.TEXTURE_2D_ARRAY, H, pe, de.width, de.height, Y.depth, 0, de.data, 0, 0) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : C ? t.texSubImage3D(i.TEXTURE_2D_ARRAY, H, 0, 0, 0, de.width, de.height, Y.depth, ge, Me, de.data) : t.texImage3D(i.TEXTURE_2D_ARRAY, H, pe, de.width, de.height, Y.depth, 0, ge, Me, de.data);
        } else {
          C && ae && t.texStorage2D(i.TEXTURE_2D, $, pe, ze[0].width, ze[0].height);
          for (let H = 0, ie = ze.length; H < ie; H++)
            de = ze[H], g.format !== Nt ? ge !== null ? C ? t.compressedTexSubImage2D(i.TEXTURE_2D, H, 0, 0, de.width, de.height, ge, de.data) : t.compressedTexImage2D(i.TEXTURE_2D, H, pe, de.width, de.height, 0, de.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : C ? t.texSubImage2D(i.TEXTURE_2D, H, 0, 0, de.width, de.height, ge, Me, de.data) : t.texImage2D(i.TEXTURE_2D, H, pe, de.width, de.height, 0, ge, Me, de.data);
        }
      else if (g.isDataArrayTexture)
        C ? (ae && t.texStorage3D(i.TEXTURE_2D_ARRAY, $, pe, Y.width, Y.height, Y.depth), t.texSubImage3D(i.TEXTURE_2D_ARRAY, 0, 0, 0, 0, Y.width, Y.height, Y.depth, ge, Me, Y.data)) : t.texImage3D(i.TEXTURE_2D_ARRAY, 0, pe, Y.width, Y.height, Y.depth, 0, ge, Me, Y.data);
      else if (g.isData3DTexture)
        C ? (ae && t.texStorage3D(i.TEXTURE_3D, $, pe, Y.width, Y.height, Y.depth), t.texSubImage3D(i.TEXTURE_3D, 0, 0, 0, 0, Y.width, Y.height, Y.depth, ge, Me, Y.data)) : t.texImage3D(i.TEXTURE_3D, 0, pe, Y.width, Y.height, Y.depth, 0, ge, Me, Y.data);
      else if (g.isFramebufferTexture) {
        if (ae)
          if (C)
            t.texStorage2D(i.TEXTURE_2D, $, pe, Y.width, Y.height);
          else {
            let H = Y.width, ie = Y.height;
            for (let ve = 0; ve < $; ve++)
              t.texImage2D(i.TEXTURE_2D, ve, pe, H, ie, 0, ge, Me, null), H >>= 1, ie >>= 1;
          }
      } else if (ze.length > 0 && Se) {
        C && ae && t.texStorage2D(i.TEXTURE_2D, $, pe, ze[0].width, ze[0].height);
        for (let H = 0, ie = ze.length; H < ie; H++)
          de = ze[H], C ? t.texSubImage2D(i.TEXTURE_2D, H, 0, 0, ge, Me, de) : t.texImage2D(i.TEXTURE_2D, H, pe, ge, Me, de);
        g.generateMipmaps = !1;
      } else
        C ? (ae && t.texStorage2D(i.TEXTURE_2D, $, pe, Y.width, Y.height), t.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, ge, Me, Y)) : t.texImage2D(i.TEXTURE_2D, 0, pe, ge, Me, Y);
      P(g, Se) && b(te), me.__version = ne.version, g.onUpdate && g.onUpdate(g);
    }
    E.__version = g.version;
  }
  function qe(E, g, F) {
    if (g.image.length !== 6) return;
    const te = ye(E, g), Z = g.source;
    t.bindTexture(i.TEXTURE_CUBE_MAP, E.__webglTexture, i.TEXTURE0 + F);
    const ne = n.get(Z);
    if (Z.version !== ne.__version || te === !0) {
      t.activeTexture(i.TEXTURE0 + F);
      const me = We.getPrimaries(We.workingColorSpace), se = g.colorSpace === Ct ? null : We.getPrimaries(g.colorSpace), le = g.colorSpace === Ct || me === se ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      const A = g.isCompressedTexture || g.image[0].isCompressedTexture, re = g.image[0] && g.image[0].isDataTexture, Y = [];
      for (let H = 0; H < 6; H++)
        !A && !re ? Y[H] = M(g.image[H], !1, !0, c) : Y[H] = re ? g.image[H].image : g.image[H], Y[H] = it(g, Y[H]);
      const Se = Y[0], ge = w(Se) || a, Me = s.convert(g.format, g.colorSpace), pe = s.convert(g.type), de = W(g.internalFormat, Me, pe, g.colorSpace), ze = a && g.isVideoTexture !== !0, C = ne.__version === void 0 || te === !0;
      let ae = S(g, Se, ge);
      ...
      if (A) {
        ...
        for (let H = 0; H < 6; H++) {
          ...
          for (let ie = 0; ie < $.length; ie++) {
            const ve = $[ie];
            g.format !== Nt ? Me !== null ? ze ? t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie, 0, 0, ve.width, ve.height, Me, ve.data) : t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie, de, ve.width, ve.height, 0, ve.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : ze ? t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie, 0, 0, ve.width, ve.height, Me, pe, ve.data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie, de, ve.width, ve.height, 0, Me, pe, ve.data);
          }
        }
      } else {
        $ = g.mipmaps, ze && C && ($.length > 0 && ae++, t.texStorage2D(i.TEXTURE_CUBE_MAP, ae, de, Y[0].width, Y[0].height));
        for (let H = 0; H < 6; H++)
          if (re) {
            ze ? t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, 0, 0, 0, Y[H].width, Y[H].height, Me, pe, Y[H].data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, 0, de, Y[H].width, Y[H].height, 0, Me, pe, Y[H].data);
            for (let ie = 0; ie < $.length; ie++) {
              const Ge = $[ie].image[H].image;
              ze ? t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie + 1, 0, 0, Ge.width, Ge.height, Me, pe, Ge.data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie + 1, de, Ge.width, Ge.height, 0, Me, pe, Ge.data);
            }
          } else {
            ze ? t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, 0, 0, 0, Me, pe, Y[H]) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, 0, de, Me, pe, Y[H]);
            for (let ie = 0; ie < $.length; ie++) {
              const ve = $[ie];
              ze ? t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie + 1, 0, 0, Me, pe, ve.image[H]) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + H, ie + 1, de, Me, pe, ve.image[H]);
            }
          }
      }
      P(g, ge) && b(i.TEXTURE_CUBE_MAP), ne.__version = Z.version, g.onUpdate && g.onUpdate(g);
    }
    E.__version = g.version;
  }
  function Ue(E, g, F, te, Z, ne) {
    ...
    t.bindFramebuffer(i.FRAMEBUFFER, E), Ve(g) ? d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, te, Z, n.get(F).__webglTexture, 0, Ce(g)) : (Z === i.TEXTURE_2D || Z >= i.TEXTURE_CUBE_MAP_POSITIVE_X && Z <= i.TEXTURE_CUBE_MAP_NEGATIVE_Z) && i.framebufferTexture2D(i.FRAMEBUFFER, te, Z, n.get(F).__webglTexture, ne), t.bindFramebuffer(i.FRAMEBUFFER, null);
  }
  function N(E, g, F) {
    if (i.bindRenderbuffer(i.RENDERBUFFER, E), g.depthBuffer && !g.stencilBuffer) {
      ...
      if (F || Ve(g)) {
        ...
        const ne = Ce(g);
        Ve(g) ? d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER, ne, te, g.width, g.height) : i.renderbufferStorageMultisample(i.RENDERBUFFER, ne, te, g.width, g.height);
      } else
        i.renderbufferStorage(i.RENDERBUFFER, te, g.width, g.height);
      i.framebufferRenderbuffer(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.RENDERBUFFER, E);
    } else if (g.depthBuffer && g.stencilBuffer) {
      const te = Ce(g);
      F && Ve(g) === !1 ? i.renderbufferStorageMultisample(i.RENDERBUFFER, te, i.DEPTH24_STENCIL8, g.width, g.height) : Ve(g) ? d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER, te, i.DEPTH24_STENCIL8, g.width, g.height) : i.renderbufferStorage(i.RENDERBUFFER, i.DEPTH_STENCIL, g.width, g.height), i.framebufferRenderbuffer(i.FRAMEBUFFER, i.DEPTH_STENCIL_ATTACHMENT, i.RENDERBUFFER, E);
    } else {
      const te = g.isWebGLMultipleRenderTargets === !0 ? g.texture : [g.texture];
      for (let Z = 0; Z < te.length; Z++) {
        const ne = te[Z], me = s.convert(ne.format, ne.colorSpace), se = s.convert(ne.type), le = W(ne.internalFormat, me, se, ne.colorSpace), A = Ce(g);
        F && Ve(g) === !1 ? i.renderbufferStorageMultisample(i.RENDERBUFFER, A, le, g.width, g.height) : Ve(g) ? d.renderbufferStorageMultisampleEXT(i.RENDERBUFFER, A, le, g.width, g.height) : i.renderbufferStorage(i.RENDERBUFFER, le, g.width, g.height);
      }
    }
  ...
  function ct(E, g) {
    ...
    const te = n.get(g.depthTexture).__webglTexture, Z = Ce(g);
    if (g.depthTexture.format === Mn)
      Ve(g) ? d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.TEXTURE_2D, te, 0, Z) : i.framebufferTexture2D(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.TEXTURE_2D, te, 0);
    else if (g.depthTexture.format === Zn)
      Ve(g) ? d.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, i.DEPTH_STENCIL_ATTACHMENT, i.TEXTURE_2D, te, 0, Z) : i.framebufferTexture2D(i.FRAMEBUFFER, i.DEPTH_STENCIL_ATTACHMENT, i.TEXTURE_2D, te, 0);
    else
  ...
  function xe(E) {
    ...
    if (E.depthTexture && !g.__autoAllocateDepthBuffer) {
      ...
      ct(g.__webglFramebuffer, E);
    } else if (F) {
      g.__webglDepthbuffer = [];
      for (let te = 0; te < 6; te++)
        t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer[te]), g.__webglDepthbuffer[te] = i.createRenderbuffer(), N(g.__webglDepthbuffer[te], E, !1);
    } else
      t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer), g.__webglDepthbuffer = i.createRenderbuffer(), N(g.__webglDepthbuffer, E, !1);
    t.bindFramebuffer(i.FRAMEBUFFER, null);
  }
  function be(E, g, F) {
    const te = n.get(E);
    g !== void 0 && Ue(te.__webglFramebuffer, E, E.texture, i.COLOR_ATTACHMENT0, i.TEXTURE_2D, 0), F !== void 0 && xe(E);
  }
  function Ae(E) {
    const g = E.texture, F = n.get(E), te = n.get(g);
    E.addEventListener("dispose", J), E.isWebGLMultipleRenderTargets !== !0 && (te.__webglTexture === void 0 && (te.__webglTexture = i.createTexture()), te.__version = g.version, o.memory.textures++);
    ...
    if (Z) {
      ...
      if (a && E.samples > 0 && Ve(E) === !1) {
        ...
        for (let le = 0; le < se.length; le++) {
          ...
          const re = s.convert(A.format, A.colorSpace), Y = s.convert(A.type), Se = W(A.internalFormat, re, Y, A.colorSpace, E.isXRRenderTarget === !0), ge = Ce(E);
    ...
    if (Z) {
      ...
      for (let se = 0; se < 6; se++)
        if (a && g.mipmaps && g.mipmaps.length > 0)
          for (let le = 0; le < g.mipmaps.length; le++)
            Ue(F.__webglFramebuffer[se][le], E, g, i.COLOR_ATTACHMENT0, i.TEXTURE_CUBE_MAP_POSITIVE_X + se, le);
        else
          Ue(F.__webglFramebuffer[se], E, g, i.COLOR_ATTACHMENT0, i.TEXTURE_CUBE_MAP_POSITIVE_X + se, 0);
      P(g, me) && b(i.TEXTURE_CUBE_MAP), t.unbindTexture();
    } else if (ne) {
      const se = E.texture;
      for (let le = 0, A = se.length; le < A; le++) {
      ...
      let se = i.TEXTURE_2D;
      if ((E.isWebGL3DRenderTarget || E.isWebGLArrayRenderTarget) && (a ? se = E.isWebGL3DRenderTarget ? i.TEXTURE_3D : i.TEXTURE_2D_ARRAY : console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")), t.bindTexture(se, te.__webglTexture), Be(se, g, me), a && g.mipmaps && g.mipmaps.length > 0)
        for (let le = 0; le < g.mipmaps.length; le++)
          Ue(F.__webglFramebuffer[le], E, g, i.COLOR_ATTACHMENT0, se, le);
      else
        Ue(F.__webglFramebuffer, E, g, i.COLOR_ATTACHMENT0, se, 0);
      P(g, me) && b(se), t.unbindTexture();
    }
    E.depthBuffer && xe(E);
  }
  function je(E) {
    const g = w(E) || a, F = E.isWebGLMultipleRenderTargets === !0 ? E.texture : [E.texture];
    ...
    if (a && E.samples > 0 && Ve(E) === !1) {
      ...
      for (let A = 0; A < g.length; A++) {
        ...
        if (re === !1 && (E.depthBuffer && (Z |= i.DEPTH_BUFFER_BIT), E.stencilBuffer && (Z |= i.STENCIL_BUFFER_BIT)), le && i.framebufferRenderbuffer(i.READ_FRAMEBUFFER, i.COLOR_ATTACHMENT0, i.RENDERBUFFER, se.__webglColorRenderbuffer[A]), re === !0 && (i.invalidateFramebuffer(i.READ_FRAMEBUFFER, [me]), i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER, [me])), le) {
          const Y = n.get(g[A]).__webglTexture;
      ...
      if (t.bindFramebuffer(i.READ_FRAMEBUFFER, null), t.bindFramebuffer(i.DRAW_FRAMEBUFFER, null), le)
        for (let A = 0; A < g.length; A++) {
          ...
          const re = n.get(g[A]).__webglTexture;
  ...
  function Ve(E) {
    const g = n.get(E);
    return a && E.samples > 0 && e.has("WEBGL_multisampled_render_to_texture") === !0 && g.__useRenderToTexture !== !1;
  }
  function $e(E) {
  ...
  function it(E, g) {
    ...
    return E.isCompressedTexture === !0 || E.isVideoTexture === !0 || E.format === Hr || F !== jt && F !== Ct && (We.getTransfer(F) === Ye ? a === !1 ? e.has("EXT_sRGB") === !0 && te === Nt ? (E.format = Hr, E.minFilter = Rt, E.generateMipmaps = !1) : g = Ha.sRGBToLinear(g) : (te !== Nt || Z !== ln) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", F)), g;
  }
  ...
  function r(s, o = Ct) {
    ...
    if (s === gs || s === _s)
      if (a = e.get("WEBGL_compressed_texture_etc"), a !== null) {
        ...
        if (s === _s) return l === Ye ? a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC : a.COMPRESSED_RGBA8_ETC2_EAC;
      } else
        return null;
  ...
  constructor(e, t) {
        ...
        if (p = e.getRenderTarget(), r.addEventListener("select", T), r.addEventListener("selectstart", T), r.addEventListener("selectend", T), r.addEventListener("squeeze", T), r.addEventListener("squeezestart", T), r.addEventListener("squeezeend", T), r.addEventListener("end", V), r.addEventListener("inputsourceschange", J), v.xrCompatible !== !0 && await t.makeXRCompatible(), r.renderState.layers === void 0 || e.capabilities.isWebGL2 === !1) {
          ...
          f = new XRWebGLBinding(r, t), d = f.createProjectionLayer(fe), r.updateRenderState({ layers: [d] }), h = new Tn(
            ...
            d.textureHeight,
            {
              format: Nt,
              type: ln,
              depthTexture: new gf(d.textureWidth, d.textureHeight, ce, void 0, void 0, void 0, void 0, void 0, void 0, k),
              stencilBuffer: v.stencil,
              colorSpace: e.outputColorSpace,
    ...
    this.updateCamera = function(D) {
      ...
      for (let ue = 0; ue < ce.length; ue++)
        j(ce[ue], k);
      ce.length === 2 ? G(b, w, R) : b.projectionMatrix.copy(w.projectionMatrix), X(D, b, k);
    };
    function X(D, k, ce) {
    ...
    function q(D, k) {
      ...
      ee && ee(D, k), k.detectedPlanes && n.dispatchEvent({ type: "planesdetected", data: k }), _ = null;
    }
    const K = new Qa();
...
function xf(i, e, t, n) {
  ...
  function c(y, M) {
    let w = r[y.id];
    w === void 0 && (_(y), w = u(y), r[y.id] = w, y.addEventListener("dispose", p));
    const R = M.program;
  ...
  function _(y) {
    ...
    for (let b = 0, W = M.length; b < W; b++) {
      ...
      for (let J = 0, Q = V.length; J < Q; J++) {
        const L = V[J], G = v(L);
        T.boundary += G.boundary, T.storage += G.storage;
      }
...
class ro {
  constructor(e = {}) {
    ...
    let J = null;
    const Q = new ke(0);
    let L = 0, G = t.width, j = t.height, X = 1, ee = null, q = null;
    const K = new lt(0, 0, G, j), D = new lt(0, 0, G, j);
    let k = !1;
    const ce = new Ja();
    ...
    let xe, be, Ae, je, Le, Ce, Ve, $e, it, E, g, F, te, Z, ne, me, se, le, A, re, Y, Se, ge, Me;
    function pe() {
      xe = new wh(N), be = new Sh(N, xe, e), xe.init(be), Se = new ff(N, xe, be), Ae = new hf(N, xe, be), je = new Lh(N), Le = new Zd(), Ce = new df(N, xe, Ae, Le, be, Se, je), Ve = new Th(M), $e = new Rh(M), it = new Gl(N, be), ge = new xh(N, xe, it, be), E = new Ch(N, it, je, ge), g = new Nh(N, E, it, je), A = new Ih(N, be, Ce), me = new Eh(Le), F = new Kd(M, Ve, $e, xe, be, ge, me), te = new vf(M, Le), Z = new Jd(), ne = new sf(xe, be), le = new vh(M, Ve, $e, Ae, g, d, l), se = new uf(M, g, be), Me = new xf(N, je, be, Ae), re = new Mh(N, xe, je, be), Y = new Ph(N, xe, je, be), je.programs = F.programs, M.capabilities = be, M.extensions = xe, M.properties = Le, M.renderLists = Z, M.shadowMap = se, M.state = Ae, M.info = je;
    }
    pe();
    const de = new _f(M, N);
    this.xr = de, this.getContext = function() {
      ...
      x !== void 0 && (X = x, this.setSize(G, j, !1));
      ...
      G = x, j = U, t.width = Math.floor(x * X), t.height = Math.floor(U * X), O === !0 && (t.style.width = x + "px", t.style.height = U + "px"), this.setViewport(0, 0, x, U);
    }, this.getDrawingBufferSize = function(x) {
      return x.set(G * X, j * X).floor();
    }, this.setDrawingBufferSize = function(x, U, O) {
      G = x, j = U, X = O, t.width = Math.floor(x * O), t.height = Math.floor(U * O), this.setViewport(0, 0, x, U);
      ...
      if (x) {
        ...
        if (z) {
          const he = b.texture.type, _e = he === ln || he === nn || he === jr || he === xn || he === Ia || he === Na, Ee = le.getClearColor(), Re = le.getClearAlpha(), Ne = Ee.r, Pe = Ee.g, De = Ee.b;
          _e ? (m[0] = Ne, m[1] = Pe, m[2] = De, m[3] = Re, N.clearBufferuiv(N.COLOR, 0, m)) : (_[0] = Ne, _[1] = Pe, _[2] = De, _[3] = Re, N.clearBufferiv(N.COLOR, 0, _));
        } else
      ...
      t.removeEventListener("webglcontextlost", ze, !1), t.removeEventListener("webglcontextrestored", C, !1), t.removeEventListener("webglcontextcreationerror", ae, !1), Z.dispose(), ne.dispose(), Le.dispose(), Ve.dispose(), $e.dispose(), g.dispose(), ge.dispose(), Me.dispose(), F.dispose(), de.dispose(), de.removeEventListener("sessionstart", bt), de.removeEventListener("sessionend", Xe), Te && (Te.dispose(), Te = null), dt.stop();
    };
    function ze(x) {
    ...
    function $(x) {
      const U = x.target;
      U.removeEventListener("dispose", $), H(U);
    }
    function H(x) {
      ie(x), Le.remove(x);
    }
    ...
    this.renderBufferDirect = function(x, U, O, B, z, he) {
      U === null && (U = qe);
      const _e = z.isMesh && z.matrixWorld.determinant() < 0, Ee = oo(x, U, O, B, z);
      Ae.setMaterial(B, _e);
      let Re = O.index, Ne = 1;
      if (B.wireframe === !0) {
      ...
      if (Re !== null && (zt = it.get(Re), Ke = Y, Ke.setIndex(zt)), z.isMesh)
        ...
        let He = B.linewidth;
        He === void 0 && (He = 1), Ae.setLineWidth(He * Ue()), z.isLineSegments ? Ke.setMode(N.LINES) : z.isLineLoop ? Ke.setMode(N.LINE_LOOP) : Ke.setMode(N.LINE_STRIP);
      ...
      if (z.isInstancedMesh)
        ...
        const He = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0, er = Math.min(O.instanceCount, He);
      ...
      return new Promise((z) => {
        function he() {
          if (B.forEach(function(_e) {
            Le.get(_e).currentProgram.isReady() && B.delete(_e);
          }), B.size === 0) {
            z(x);
            return;
          }
    ...
    dt.setAnimationLoop(Je), typeof self < "u" && dt.setContext(self), this.setAnimationLoop = function(x) {
      Ge = x, de.setAnimationLoop(x), x === null ? dt.stop() : dt.start();
      ...
      if (se.render(O, x, U), ue === !0 && me.endShadows(), this.info.autoReset === !0 && this.info.reset(), le.render(v, x), p.setupLights(M._useLegacyLights), U.isArrayCamera) {
        ...
        for (let z = 0, he = B.length; z < he; z++) {
          const _e = B[z];
          Qr(v, x, _e, _e.viewport);
        }
      } else
        Qr(v, x, U);
      b !== null && (Ce.updateMultisampleRenderTarget(b), Ce.updateRenderTargetMipmap(b)), x.isScene === !0 && x.onAfterRender(M, x, U), ge.resetDefaultState(), W = -1, S = null, y.pop(), y.length > 0 ? p = y[y.length - 1] : p = null, h.pop(), h.length > 0 ? v = h[h.length - 1] : v = null;
    };
    function Ot(x, U, O, B) {
      ...
      if (x.layers.test(U.layers)) {
        if (x.isGroup)
          ...
          if (!x.frustumCulled || ce.intersectsSprite(x)) {
            ...
            const _e = g.update(x), Ee = x.material;
            Ee.visible && v.push(x, _e, Ee, O, we.z, null);
          }
        } else if ((x.isMesh || x.isLine || x.isPoints) && (!x.frustumCulled || ce.intersectsObject(x))) {
          const _e = g.update(x), Ee = x.material;
          if (B && (x.boundingSphere !== void 0 ? (x.boundingSphere === null && x.computeBoundingSphere(), we.copy(x.boundingSphere.center)) : (_e.boundingSphere === null && _e.computeBoundingSphere(), we.copy(_e.boundingSphere.center)), we.applyMatrix4(x.matrixWorld).applyMatrix4(Be)), Array.isArray(Ee)) {
            const Re = _e.groups;
            for (let Ne = 0, Pe = Re.length; Ne < Pe; Ne++) {
              const De = Re[Ne], Ze = Ee[De.materialIndex];
              Ze && Ze.visible && v.push(x, _e, Ze, O, we.z, De);
            }
          } else Ee.visible && v.push(x, _e, Ee, O, we.z, null);
        }
      }
      const he = x.children;
    ...
    function Qr(x, U, O, B) {
      const z = x.opaque, he = x.transmissive, _e = x.transparent;
      p.setupLightsView(O), ue === !0 && me.setGlobalState(M.clippingPlanes, O), he.length > 0 && ao(z, he, U, O), B && Ae.viewport(T.copy(B)), z.length > 0 && fi(z, U, O), he.length > 0 && fi(he, U, O), _e.length > 0 && fi(_e, U, O), Ae.buffers.depth.setTest(!0), Ae.buffers.depth.setMask(!0), Ae.buffers.color.setMask(!0), Ae.setPolygonOffset(!1);
    }
    function ao(x, U, O, B) {
      ...
      Re === !0 && (Ce.updateMultisampleRenderTarget(Te), Ce.updateRenderTargetMipmap(Te)), M.setRenderTarget(_e), M.setClearColor(Q, L), M.toneMapping = Ee;
    }
    function fi(x, U, O) {
      const B = U.isScene === !0 ? U.overrideMaterial : null;
      for (let z = 0, he = x.length; z < he; z++) {
        const _e = x[z], Ee = _e.object, Re = _e.geometry, Ne = B === null ? _e.material : B, Pe = _e.group;
    ...
    function pi(x, U, O) {
      U.isScene !== !0 && (U = qe);
      const B = Le.get(x), z = p.state.lights, he = p.state.shadowsArray, _e = z.state.version, Ee = F.getParameters(x, z.state, he, U, O), Re = F.getProgramCacheKey(Ee);
      let Ne = B.programs;
    ...
    function oo(x, U, O, B, z) {
      ...
      const zt = O.morphAttributes.position || O.morphAttributes.normal || O.morphAttributes.color, Ke = zt !== void 0 ? zt.length : 0, He = Le.get(B), er = p.state.lights;
      if (ue === !0 && (fe === !0 || x !== S)) {
        const Et = x === S && B.id === W;
        me.setState(B, x, Et);
      }
      let Qe = !1;
      B.version === He.__version ? (He.needsLights && He.lightsStateVersion !== er.state.version || He.outputColorSpace !== Ee || z.isInstancedMesh && He.instancing === !1 || !z.isInstancedMesh && He.instancing === !0 || z.isSkinnedMesh && He.skinning === !1 || !z.isSkinnedMesh && He.skinning === !0 || z.isInstancedMesh && He.instancingColor === !0 && z.instanceColor === null || z.isInstancedMesh && He.instancingColor === !1 && z.instanceColor !== null || He.envMap !== Re || B.fog === !0 && He.fog !== he || He.numClippingPlanes !== void 0 && (He.numClippingPlanes !== me.numPlanes || He.numIntersection !== me.numIntersection) || He.vertexAlphas !== Ne || He.vertexTangents !== Pe || He.morphTargets !== De || He.morphNormals !== Ze || He.morphColors !== St || He.toneMapping !== rt || be.isWebGL2 === !0 && He.morphTargetsCount !== Ke) && (Qe = !0) : (Qe = !0, He.__version = B.version);
      let un = He.currentProgram;
      Qe === !0 && (un = pi(B, U, z));
      let is = !1, Qn = !1, tr = !1;
      const ft = un.getUniforms(), hn = He.uniforms;
      ...
      if ((nr.position !== void 0 || nr.normal !== void 0 || nr.color !== void 0 && be.isWebGL2 === !0) && A.update(z, O, un), (Qn || He.receiveShadow !== z.receiveShadow) && (He.receiveShadow = z.receiveShadow, ft.setValue(N, "receiveShadow", z.receiveShadow)), B.isMeshGouraudMaterial && B.envMap !== null && (hn.envMap.value = Re, hn.flipEnvMap.value = Re.isCubeTexture && Re.isRenderTargetTexture === !1 ? -1 : 1), Qn && (ft.setValue(N, "toneMappingExposure", M.toneMappingExposure), He.needsLights && lo(hn, tr), he && B.fog === !0 && te.refreshFogUniforms(hn, he), te.refreshMaterialUniforms(hn, B, X, j, Te), Vi.upload(N, ts(He), hn, Ce)), B.isShaderMaterial && B.uniformsNeedUpdate === !0 && (Vi.upload(N, ts(He), hn, Ce), B.uniformsNeedUpdate = !1), B.isSpriteMaterial && ft.setValue(N, "center", z.center), ft.setValue(N, "modelViewMatrix", z.modelViewMatrix), ft.setValue(N, "normalMatrix", z.normalMatrix), ft.setValue(N, "modelMatrix", z.matrixWorld), B.isShaderMaterial || B.isRawShaderMaterial) {
    ...
    this.getActiveCubeFace = function() {
      ...
      if (x) {
        ...
        const Ne = x.texture;
        (Ne.isData3DTexture || Ne.isDataArrayTexture || Ne.isCompressedArrayTexture) && (_e = !0);
      ...
      W = -1;
    }, this.readRenderTargetPixels = function(x, U, O, B, z, he, _e) {
      ...
      const z = U.image.width, he = U.image.height, _e = Se.convert(O.format), Ee = Se.convert(O.type);
      Ce.setTexture2D(O, 0), N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL, O.flipY), N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL, O.premultiplyAlpha), N.pixelStorei(N.UNPACK_ALIGNMENT, O.unpackAlignment), U.isDataTexture ? N.texSubImage2D(N.TEXTURE_2D, B, x.x, x.y, z, he, _e, Ee, U.image.data) : U.isCompressedTexture ? N.compressedTexSubImage2D(N.TEXTURE_2D, B, x.x, x.y, U.mipmaps[0].width, U.mipmaps[0].height, _e, U.mipmaps[0].data) : N.texSubImage2D(N.TEXTURE_2D, B, x.x, x.y, _e, Ee, U.image), B === 0 && O.generateMipmaps && N.generateMipmap(N.TEXTURE_2D), Ae.unbindTexture();
    }, this.copyTextureToTexture3D = function(x, U, O, B, z = 0) {
      if (M.isWebGL1Renderer) {
        console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");
        return;
      }
      const he = x.max.x - x.min.x + 1, _e = x.max.y - x.min.y + 1, Ee = x.max.z - x.min.z + 1, Re = Se.convert(B.format), Ne = Se.convert(B.type);
      let Pe;
      ...
      R = 0, P = 0, b = null, Ae.reset(), ge.reset();
...
class Ef extends _t {
  ...
  raycast(e, t) {
    ...
    if (c !== null) {
      ...
      for (let _ = d, v = m; _ < v; _++)
        zi.fromBufferAttribute(f, _), Aa(zi, _, l, r, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes, n = Object.keys(t);
...
const Ra = { type: "change" }, Ir = { type: "start" }, wa = { type: "end" }, Gi = new Zr(), Ca = new tn(), Af = Math.cos(70 * pl.DEG2RAD);
class Rf extends An {
  constructor(e, t) {
    super(), this.object = e, this.domElement = t, this.domElement.style.touchAction = "none", this.enabled = !0, this.target = new I(), this.cursor = new I(), this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minTargetRadius = 0, this.maxTargetRadius = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = 0.05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = { LEFT: "ArrowLeft", UP: "ArrowUp", RIGHT: "ArrowRight", BOTTOM: "ArrowDown" }, this.mouseButtons = { LEFT: Rn.ROTATE, MIDDLE: Rn.DOLLY, RIGHT: Rn.PAN }, this.touches = { ONE: wn.ROTATE, TWO: wn.DOLLY_PAN }, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._domElementKeyEvents = null, this.getPolarAngle = function() {
      ...
      A.addEventListener("keydown", g), this._domElementKeyEvents = A;
      ...
      const A = new I(), re = new yn().setFromUnitVectors(e.up, new I(0, 1, 0)), Y = re.clone().invert(), Se = new I(), ge = new yn(), Me = new I(), pe = 2 * Math.PI;
      return function(ze = null) {
        ...
        if (n.zoomToCursor && P) {
          ...
          if (n.object.isPerspectiveCamera) {
            ...
            ie = q(ve * c);
            const Ge = ve - ie;
            n.object.position.addScaledVector(w, Ge), n.object.updateMatrixWorld();
          } else if (n.object.isOrthographicCamera) {
            const ve = new I(R.x, R.y, 0);
            ve.unproject(n.object), n.object.zoom = Math.max(n.minZoom, Math.min(n.maxZoom, n.object.zoom / c)), n.object.updateProjectionMatrix(), H = !0;
            const Ge = new I(R.x, R.y, 0);
            Ge.unproject(n.object), n.object.position.sub(Ge).add(ve), n.object.updateMatrixWorld(), ie = A.length();
          } else
            console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."), n.zoomToCursor = !1;
          ie !== null && (this.screenSpacePanning ? n.target.set(0, 0, -1).transformDirection(n.object.matrix).multiplyScalar(ie).add(n.object.position) : (Gi.origin.copy(n.object.position), Gi.direction.set(0, 0, -1).transformDirection(n.object.matrix), Math.abs(n.object.up.dot(Gi.direction)) < Af ? e.lookAt(n.target) : (Ca.setFromNormalAndCoplanarPoint(n.object.up, n.target), Gi.intersectPlane(Ca, n.target))));
        } else n.object.isOrthographicCamera && (n.object.zoom = Math.max(n.minZoom, Math.min(n.maxZoom, n.object.zoom / c)), n.object.updateProjectionMatrix(), H = !0);
        return c = 1, P = !1, H || Se.distanceToSquared(n.object.position) > o || 8 * (1 - ge.dot(n.object.quaternion)) > o || Me.distanceToSquared(n.target) > 0 ? (n.dispatchEvent(Ra), Se.copy(n.object.position), ge.copy(n.object.quaternion), Me.copy(n.target), H = !1, !0) : !1;
      };
    }(), this.dispose = function() {
      n.domElement.removeEventListener("contextmenu", Z), n.domElement.removeEventListener("pointerdown", Le), n.domElement.removeEventListener("pointercancel", Ve), n.domElement.removeEventListener("wheel", E), n.domElement.removeEventListener("pointermove", Ce), n.domElement.removeEventListener("pointerup", Ve), n._domElementKeyEvents !== null && (n._domElementKeyEvents.removeEventListener("keydown", g), n._domElementKeyEvents = null);
    };
    const n = this, r = {
      NONE: -1,
      ROTATE: 0,
    ...
    let c = 1;
    const u = new I(), f = new Oe(), d = new Oe(), m = new Oe(), _ = new Oe(), v = new Oe(), p = new Oe(), h = new Oe(), y = new Oe(), M = new Oe(), w = new I(), R = new Oe();
    let P = !1;
    const b = [], W = {};
    function S(A) {
    ...
    const Q = function() {
      ...
      return function(Y, Se) {
        ...
        if (n.object.isPerspectiveCamera) {
          ...
          let pe = A.length();
          pe *= Math.tan(n.object.fov / 2 * Math.PI / 180), Q(2 * Y * pe / ge.clientHeight, n.object.matrix), L(2 * Se * pe / ge.clientHeight, n.object.matrix);
        } else n.object.isOrthographicCamera ? (Q(Y * (n.object.right - n.object.left) / n.object.zoom / ge.clientWidth, n.object.matrix), L(Se * (n.object.top - n.object.bottom) / n.object.zoom / ge.clientHeight, n.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), n.enablePan = !1);
      };
    }();
    function j(A) {
    ...
    function ee(A) {
      if (!n.zoomToCursor)
        return;
      P = !0;
      const re = n.domElement.getBoundingClientRect(), Y = A.clientX - re.left, Se = A.clientY - re.top, ge = re.width, Me = re.height;
      R.x = Y / ge * 2 - 1, R.y = -(Se / Me) * 2 + 1, w.set(R.x, R.y, 1).unproject(n.object).sub(n.object.position).normalize();
    }
    function q(A) {
    ...
    function fe(A) {
      v.set(A.clientX, A.clientY), p.subVectors(v, _).multiplyScalar(n.panSpeed), G(p.x, p.y), _.copy(v), n.update();
    }
    function Te(A) {
    ...
    function Be(A) {
      ...
      switch (A.code) {
        case n.keys.UP:
          A.ctrlKey || A.metaKey || A.shiftKey ? J(2 * Math.PI * n.rotateSpeed / n.domElement.clientHeight) : G(0, n.keyPanSpeed), re = !0;
          break;
        case n.keys.BOTTOM:
          A.ctrlKey || A.metaKey || A.shiftKey ? J(-2 * Math.PI * n.rotateSpeed / n.domElement.clientHeight) : G(0, -n.keyPanSpeed), re = !0;
          break;
        case n.keys.LEFT:
          A.ctrlKey || A.metaKey || A.shiftKey ? V(2 * Math.PI * n.rotateSpeed / n.domElement.clientHeight) : G(n.keyPanSpeed, 0), re = !0;
          break;
        case n.keys.RIGHT:
          A.ctrlKey || A.metaKey || A.shiftKey ? V(-2 * Math.PI * n.rotateSpeed / n.domElement.clientHeight) : G(-n.keyPanSpeed, 0), re = !0;
          break;
    ...
    function ct(A) {
      if (b.length == 1)
        ...
        const Y = le(A), Se = 0.5 * (A.pageX + Y.x), ge = 0.5 * (A.pageY + Y.y);
        d.set(Se, ge);
      }
    ...
    function xe(A) {
      ...
      p.subVectors(v, _).multiplyScalar(n.panSpeed), G(p.x, p.y), _.copy(v);
    }
    function be(A) {
      const re = le(A), Y = A.pageX - re.x, Se = A.pageY - re.y, ge = Math.sqrt(Y * Y + Se * Se);
      y.set(0, ge), M.set(0, Math.pow(y.y / h.y, n.zoomSpeed)), j(M.y), h.copy(y);
    }
    function Ae(A) {
...
class wf {
  constructor(e, t = {
    ...
    this.container = e, this.scene = new Sf(), this.camera = new wt(75, 1, 0.1, 8e3), this.renderer = new ro({ antialias: !0, preserveDrawingBuffer: !0 }), this.controls = null, this.particles = null, this.pointCloudData = null, this.particleTexture = this.createParticleTexture(), this.animationId = null, this.resizeObserver = null, this.worker = null, this.settings = {
      url: t.url,
  ...
  init() {
    ...
    this.scene.add(r), this.setupResizeObserver(), this.setupWorker(), this.loadGLBPointCloudFromURL(), this.animate();
  }
  setupControls() {
  ...
  setupWorker() {
    ...
    this.worker = new Worker(URL.createObjectURL(t)), this.worker.onmessage = (n) => {
      this.handleWorkerMessage(n.data);
    }, this.worker.onerror = (n) => {
      console.error("Worker error:", n), this.settings.onError && this.settings.onError(new Error("Worker failed: " + n.message));
    };
  }
  handleWorkerMessage(e) {
    if (!e.success) {
      console.error("Worker error:", e.error), this.settings.onError && this.settings.onError(new Error(e.error));
      return;
    }
    switch (e.type) {
      case "metadata":
        this.pointCloudData = e.metadata, this.totalParticles = e.totalParticles, this.initializeGeometry();
        break;
      case "chunk":
        this.processChunk(e);
        break;
  ...
  initializeGeometry() {
    this.particles && (this.scene.remove(this.particles), this.particles.geometry.dispose(), this.particles.material.dispose()), this.geometry = new Kt(), this.positions = new Float32Array(this.totalParticles * 3), this.currentParticleCount = 0;
    const e = this.pointCloudData.originalModelSize || 1, t = this.settings.particleSize * (e / 100), n = new so({
    ...
    this.particles = new Ef(this.geometry, n), this.scene.add(this.particles);
  }
  processChunk(e) {
    const t = new Float32Array(e.chunk), n = e.startIndex;
    for (let s = 0; s < t.length; s++)
      this.positions[n + s] = t[s];
    this.currentParticleCount = Math.floor((n + t.length) / 3), this.geometry.setAttribute(
      "position",
      new Ft(this.positions.slice(0, this.currentParticleCount * 3), 3)
    ), this.geometry.attributes.position.needsUpdate = !0;
    const r = e.chunkIndex / e.totalChunks;
    this.settings.onProgress && this.settings.onProgress(r), console.log(`Loaded chunk ${e.chunkIndex + 1}/${e.totalChunks} (${this.currentParticleCount.toLocaleString()} particles)`);
  }
  finalizeGeometry() {
    console.log(`GLB loading complete: ${this.currentParticleCount.toLocaleString()} particles loaded`), this.fitCameraToPointCloud(), this.settings.onProgress && this.settings.onProgress(1);
  }
  ...
  async loadGLBPointCloudFromURL() {
    try {
      ...
      const e = await fetch(this.settings.url);
      if (!e.ok)
        throw new Error(`HTTP error! status: ${e.status}`);
      const t = await e.arrayBuffer();
      console.log("GLB file loaded, processing in worker..."), this.worker.postMessage({
        arrayBuffer: t,
        chunkSize: 5e3
      }, [t]);
    } catch (e) {
  ...
  fitCameraToPointCloud() {
    ...
    if (this.pointCloudData && this.pointCloudData.camera) {
      const c = this.pointCloudData.camera;
      ...
      d.setFromSpherical(f), d.add(u), this.camera.position.copy(d), this.camera.lookAt(u), this.controls && (this.controls.target.copy(u), this.controls.update()), console.log("Camera position restored from GLB metadata");
      return;
    }
  ...
  destroy() {
    this.animationId && (cancelAnimationFrame(this.animationId), this.animationId = null), this.worker && (this.worker.terminate(), this.worker = null), this.particles && (this.particles.geometry.dispose(), this.particles.material.dispose(), this.scene.remove(this.particles)), this.particleTexture && this.particleTexture.dispose(), this.renderer && (this.renderer.dispose(), this.container && this.renderer.domElement.parentNode === this.container && this.container.removeChild(this.renderer.domElement)), this.resizeObserver && (this.resizeObserver.disconnect(), this.resizeObserver = null), this.windowResizeHandler && (window.removeEventListener("resize", this.windowResizeHandler), this.windowResizeHandler = null), this.container && (this.container.innerHTML = ""), console.log("GLBPointCloudViewer destroyed");
  }
}
export {
  wf as default
